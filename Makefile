...
clean:
	rm popZips emsZips schoolZips restZips srCombined relevantPops emsPopZips allThree.txt goyishSchools goyishZips treifRests treifZips goyishData FinalGraph.pdf goyishCombined
